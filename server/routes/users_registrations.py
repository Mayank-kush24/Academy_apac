...
def _users_base():
    """Query base for all users (cohort-specific user_pii_combined view)."""
    return _PII().query
...
def download_csv():
    ...
    try:
        ...
        writer.writerow([
            'Name', 'Country', 'State', 'City', 'Organization',
            'Designation', 'Occupation', 'Industry',
        ])
        for r in query.all():
            writer.writerow([
